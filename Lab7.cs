...
namespace Lab7
{
    class Program
    {
        ...
        class CountClient
        {
            string name;
            int num;
            public CountClient(int vNum, string vName)
            {
                num = vNum;
                name = vName;
            }
        ...
        public class Control
        {
            ...
            static int num = 0;
            public Control(int vNum, string vName)
            {
                num = vNum;
                name = vName;
            }
            CountClient Bank = new CountClient(num, name);
        ...
        class ClientException : Exception
        {
            public int value;
            public string str;
            public ClientException(int val)
            {
                value = val;
                Console.WriteLine("Такого не существует!");
            }
            public ClientException(string vStr)
            {
                str = vStr;
                Console.WriteLine($"Клиента {str} не существует");
            }
        }
        class ComandException : Exception
        {
        ...
        class DelException : ClientException
        {
            public int size;
            public DelException(int val, int s) : base(val)
            {
                size = s;
                value = val;
        ...
        public static Control Create()
        {
            ...
            Console.WriteLine("Введите филиал банка: ");
            int num = 354;
            try
            {
            ...
            {
                Console.WriteLine("Филиал банка задан.");
            }
            return new Control(num, name);
        }                                   

        public static void Comands(ref Control bank)
        {
            int k = 0;
            do
            {
